---
title: "그리디 알고리즘"
description: "그리디 알고리즘의 정의와 특징, 문제 적용 방법에 대해 정리한 글입니다."
date: 2026-01-30
tags: [ "알고리즘", "그리디 알고리즘" ]
slug: "post-20260130-915aef"
---
...
만약 증명할 수 없다면 알고리즘의 해는 부분 최적 해일 수 있다. 이 경우 휴리스틱 알고리즘(_heuristic algorithm_) 이라고 부른다.  
휴리스틱 알고리즘의 성능은 실험에 의해 조사된다.   

위 특징을 가지고 그리디 알고리즘으로 어떻게 문제에 접근해야 할까? 시작은 **정렬**이다.  
