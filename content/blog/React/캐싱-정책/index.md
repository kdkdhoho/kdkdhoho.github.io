...
date: 2026-01-24
tags: ["React", "SPA", "캐싱", "S3", "CloudFront", "Tiered TTLs"]
---
...
하지만 이렇게 모든 파일을 직접 한 줄씩 작성하는 것은 너무 비효율적이다. 이때는 [s3-spa-upload](https://www.npmjs.com/package/s3-spa-upload) 라이브러리를 사용하면 지정한 디렉터를 S3에 업로드하고, 위에서 언급한 대로 각 파일에 Cache-Control 헤더를 설정한다. 
