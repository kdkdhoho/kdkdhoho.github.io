---
title: "React 배포 방식을 EC2에서 S3와 CloudFront로 변경한 이유"
...
이를 해결하기 위해 당시에는 가장 빠르고 단순한 방법인 **CloudFront 캐시 무효화(Invalidation)**를 수행했다. 사용자 규모가 작았고 비즈니스적으로 우선순위가 높은 업무가 많았기 때문이다. 만약 더 근본적인 해결이 필요했다면 AWS가 권장하는 Tiered TTLs[^1] 방식을 적용했을 것이다.
...
[^2]: https://docs.aws.amazon.com/cli/latest/topic/s3-config.html
